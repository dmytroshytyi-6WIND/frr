...
bgp_peer_get_connection_direction(struct peer_connection *connection)
{
	return connection->dir;
}

const char *bgp_peer_get_connection_direction_string(struct peer_connection *connection);
